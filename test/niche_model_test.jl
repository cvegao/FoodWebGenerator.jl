include("../src/niche_model.jl")

@testset "Niche Model Tests" begin
    @testset "Connectance matches target C" begin
        ...
        atol_C = 0.02  # absolute tolerance allowed between mean empirical C and target C
